;-------------------------------------------------------------------------------
; glscript-0.1-beta.nsi
;
; NSIS script for glScript 0.1 beta release setup.
;
...
Section "Main"
  ...
  File ".\..\bin\samples\js\rotating-cube-demo.js"
  File ".\..\bin\samples\js\cross-line-demo.js"
  File ".\..\bin\samples\js\events-demo.js"
  File ".\..\bin\samples\js\hello-demo.js"
  File ".\..\bin\samples\js\opengl-constants.js"
  File ".\..\bin\samples\js\threed-demo.js"
  File ".\..\bin\samples\js\rotating-sun-demo.js"

  SetOutPath $INSTDIR\samples\vbs
  File ".\..\bin\samples\vbs\rotating-cube-demo.vbs"
  File ".\..\bin\samples\vbs\cross-line-demo.vbs"
  File ".\..\bin\samples\vbs\events-demo.vbs"
  File ".\..\bin\samples\vbs\hello-demo.vbs"
  File ".\..\bin\samples\vbs\opengl-constants.vbs"
  File ".\..\bin\samples\vbs\threed-demo.vbs"
  File ".\..\bin\samples\vbs\rotating-sun-demo.vbs"
